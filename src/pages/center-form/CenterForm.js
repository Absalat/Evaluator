...
function CenterForm(props) {
  ...
  return (
    <>
      ...
      >
        <Alert severity="success">{props.schoolEvaluation.submitSuccess}</Alert>
      </Snackbar>
      <Snackbar
        autoHideDuration={1000}
        anchorOrigin={{ vertical: "top", horizontal: "right" }}
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <TeachingAndLearning
          ...
          sert_num_of_project_teams={formik.values.sert_num_of_project_teams}
        ...
        <Entrepreneurship
          onChangeHandler={formik.handleChange}
          courses_num_of_students={formik.values.courses_num_of_students}
          training_num_of_trainings={formik.values.training_num_of_trainings}
          training_num_of_students={formik.values.training_num_of_students}
          project_num_of_projects={formik.values.project_num_of_projects}
          project_num_of_students={formik.values.project_num_of_students}
        ...
        <Publication
          ...
          conference_workshop_organized_international={
            formik.values.conference_workshop_organized_international
          }
          seminar_school_speaker={formik.values.seminar_school_speaker}
          seminar_external_speaker={formik.values.seminar_external_speaker}
        />
        <Box mt={2} />
