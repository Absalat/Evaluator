    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <Snackbar
          ...
          onClose={props.resetChairSelfEvaluation}
        >
          <Alert severity="error">{props.chairSelfEvaluation.error}</Alert>
        </Snackbar>
        ...
        <ChairProfile
          onChangeHandler={formik.handleChange}
          num_of_technical_staff={formik.values.num_of_technical_staff}
          ...
          num_of_asst_professors={formik.values.num_of_asst_professors}
          num_of_assoc_professors={formik.values.num_of_assoc_professors}
          num_of_full_professors={formik.values.num_of_full_professors}
        />
        <Box mt={2} />
        <StaffCapacityBuilding
          ...
          special_training_started={formik.values.special_training_started}
          special_training_completed={formik.values.special_training_completed}
        />
        <Box mt={2} />
        <TeachingAndLearning
          onChangeHandler={formik.handleChange}
        ...
        <Research
          ...
          msc_students_supervision_manuscripts_produced={
            formik.values.msc_students_supervision_manuscripts_produced
          }
        />
        <Box mt={2} />
        <Publication
