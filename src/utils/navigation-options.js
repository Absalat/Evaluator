...
const faculityNavOptions = [
    ...
    {
        link: "/faculity/self-evaluation/view",
        icon: <Visibility color="primary" />,
        text: "View Filled Faculity Evaluation Form",
        role: [config.roles.faculty],
    },
    {
    ...
    {
        link: "/chair/self-evaluation/view",
        icon: <Visibility color="primary" />,
        text: "View Filled Chair Evaluation Form",
        role: [config.roles.chair],
    },
    {
        link: "/users",
    ...
    {
        link: "/center/self-evaluation/new",
        icon: <AddBoxIcon color="primary" />,
        text: "School Evaluation Form",
        role: [config.roles.dean],
    },
    {
        link: "/center/self-evaluation/view",
        icon: <Visibility color="primary" />,
        text: "View Filled School Evaluation Form",
        role: [config.roles.dean],
    },
];
